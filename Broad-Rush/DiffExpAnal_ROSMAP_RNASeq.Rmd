...
# Github link
thisRepo <- getRepo(repository = "th1vairam/ampAdScripts", ref="branch", refName='diffexp')
...
```{r contrast.fit, cache=TRUE, fig.height=20, fig.width=25}
...
```{r sample.clustering, fig.height=10, fig.width=10}
